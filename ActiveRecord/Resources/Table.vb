...
Namespace ActiveRecord
    Partial Public Class Resource
        ...
        Public Shared Function Table(resourceType As Type, Optional tableIndex As Int32 = 0) As String
        ...
        Public Function Table(Optional tableIndex As Int32 = 0) As String
