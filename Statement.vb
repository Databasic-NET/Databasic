...
Public MustInherit Class Statement
    ...
    Protected Shared Function create(sql As String, connection As Connection) As Statement
    ...
    ''' <param name="transaction">SQL transaction instance with connection instance inside.</param>
    ''' <returns>New specificly typed SQL statement.</returns>
    Protected Shared Function create(sql As String, transaction As Transaction) As Statement
        Return Activator.CreateInstance(
    ...
    Public Shared Function Prepare(sql As String) As Statement
        Return Statement.create(sql, Connection.Get())
    End Function
    ''' <summary>
    ''' Create and prepare database SQL statement. Put '@' char before all param names in your SQL code.
    ''' </summary>
    ...
    Public Shared Function Prepare(sql As String, Optional connectionName As String = Database.DEFAUT_CONNECTION_NAME) As Statement
        Return Statement.create(sql, Connection.Get(connectionName))
    End Function
    ''' <summary>
    ''' Create and prepare database SQL statement. Put '@' char before all param names in your SQL code.
    ''' </summary>
    ...
    Public Shared Function Prepare(sql As String, Optional connection As Connection = Nothing) As Statement
        Return Statement.create(sql, connection)
    End Function
    ''' <summary>
    ''' Create and prepare database SQL statement. Put '@' char before all param names in your SQL code.
    ...
    Public Shared Function Prepare(sql As String, Optional transaction As Transaction = Nothing) As Statement
        Return Statement.create(sql, transaction)
    End Function
