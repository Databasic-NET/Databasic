Namespace Provider
    Partial Public Class Resource
        ...
        Public Overridable Function Update(connection As Connection, instanceType As Type, data As Dictionary(Of String, Object), uniqueColumnName As String, uniqueColumnValue As Object) As Int32
            ...
            Return Statement.Prepare(sql, connection).Exec(data)
        End Function
        ...
        Public Overridable Function Save(connection As Connection, ByRef instance As ActiveRecord.Entity) As Int32
        ...
        Public Overridable Function Delete(connection As Connection, instance As ActiveRecord.Entity) As Int32
            Dim table As String = instance.TableName()
