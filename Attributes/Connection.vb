Public Class ConnectionAttribute
    Inherits Attribute
	Public ConnectionIndex As Int32 = Databasic.Defaults.CONNECTION_INDEX
	Public Sub New(configConnectionName As String)
        ...
        End If
    End Sub
    Public Sub New(Optional configConnectionIndex As Int32 = Databasic.Defaults.CONNECTION_INDEX)
