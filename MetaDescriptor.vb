...
Public Class MetaDescriptor
	...
	Private Shared Sub _completeColumnsCollections(type As Type, ByRef result As MetaDescription)
		...
		Dim columnAttr As ColumnAttribute, formatAttr As FormatAttribute, formatProvider As IFormatProvider
		Dim trimAttr As TrimAttribute, trimChars As Char(), keyName As String
		Dim primaryKeyAttr As PrimaryKeyAttribute, uniqueKeyAttr As UniqueKeyAttribute, autoIncrementAttr As AutoIncrementAttribute
